        ...
        <div class="container">
           ...
           <div class="collapse navbar-collapse" id="Navbar"></div>
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="./bookId.php"><span class="fa fa-list fa-lg"></span> Booking Details</a></li>
                            ...
                            <div class="form-group row">
                                <div class="offset-md-2 col-md-10">
                                 <!--  <input class="btn btn-primary" type="button" value="Check">-->
                                    ...
                                    <button type="submit" name="cancelreserve2" class="btn btn-info" role="button">Cancel Reservation</button>
