        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse  justify-content-end" id="Navbar">
                <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="./bookId.php"><span class="fa fa-list fa-lg"></span> Booking Details</a></li>
    ...
    <header class="jumbotron">
        ...
        <div class="row row-header">
                <div class="col-12 align-self-center">
                      <h1>If you do not need a reservation, please make sure to delete the reservation immediately </h1>
                      <h1>so that fellow members are allowed to reserve it.</h1>
    ...
    <div class="container"> 
                ...
                <div id="carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                      ...
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/eoe.jpg" alt="Second slide">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/DO.jpg" alt="Third slide">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/seminar.jpg" alt="Fourth slide">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/cs.jpg" alt="Fifth slide">
                      </div>
        ...
        <div class="row row-content">
            <div class="col-sm-8 offset-sm-4">
                  ...
                  <a href="./bookhall.php"><h1>Make your reservation</h1> </a>
            </div>
        </div>
